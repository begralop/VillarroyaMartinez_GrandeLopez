<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="WebPage.Login" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8">
...
<body>
 ...
 <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" id="dateid" name="datid" runat="server">
  </div>
  <div class="form-group">
     <asp:Button CssClass="btn btn-danger"  ID="Button1" runat="server" Text="Edit reserve" />
  </div>

   <div class="form-group">
     <asp:Button CssClass="btn btn-danger"  ID="Button2" runat="server" Text="Delete reserve" />
  </div>
            </form>
